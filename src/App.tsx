...
import { ForceFieldRedirect } from "@/field/ForceFieldRedirect";
...
import ReferenceGuides from "./pages/ReferenceGuides";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            />
            <Route
              path="/dashboard/visits/:visitId/asd-report/capture"
              element={
                <ProtectedRoute>
